...
if ( $OU -eq 'NONPROD')
{
    $DomainJoinOU = "OU=computers,OU=NONPROD,DC=nonprod,DC=example,DC=internal"
}
elseif ($OU -eq 'PROD')
{
    $DomainJoinOU = "OU=computers,OU=PROD,DC=prod,DC=example,DC=internal"
}
else {
    $DomainJoinOU = "OU=computers,DC=example,DC=internal"
}
