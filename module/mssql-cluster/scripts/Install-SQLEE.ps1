...
$SQLAdminGroupName = $DomainNetBIOSName + '\' + $SQLAdminGroup
...
$SACredentials  = (New-Object PSCredential('sa',(ConvertTo-SecureString $SQLUser.SAPassword -AsPlainText -Force)))
...
Configuration SQLInstall {
    ...
    Node 'localhost'{
        ...
        SqlSetup 'InstallDefaultInstance'{
            ...
            SQLSysAdminAccounts    = $ClusterAdminUser, $SQLAdminUser, $SQLAdminGroupName
            ...
            SQLUserDBLogDir        = 'L:\MSSQL\Log'
            SQLTempDBDir           = 'T:\MSSQL\Temp'
            SQLTempDBLogDir        = 'T:\MSSQL\Temp'
